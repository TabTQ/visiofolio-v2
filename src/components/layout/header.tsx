...
import { Home, Briefcase, GraduationCap, Code, UserCircle, Menu, Phone } from 'lucide-react'; // Minimalist line icons, added Phone
      ...
      <nav className="container mx-auto px-4 py-3 flex justify-between items-center">
        <Link href="/" passHref>
          <div className="flex flex-col items-start cursor-pointer hover:opacity-80 transition-opacity">
             ...
             <span className="text-xs text-muted-foreground/80 flex items-center mt-0.5"> {/* Adjusted margin */}
                <Phone className="mr-1 h-3 w-3" /> +1 (123) 456-7890 {/* Replace with actual number */}
            </span>
          </div>
